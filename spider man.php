...
<div class="play-container container">
  <!--Play image-->
  <img src="images/spider man.jpg" alt="" class="play-img">
  <!-- Play text-->
  <div class="play-text">
...
<!--Video box-->
<div class="video-box">
  <video id="myvideo" src="play-page/spider man.mp4" controls=""></video>
  <!--close video-->
...
<div class="about-movie container">
  ...
  <div class="cast">
    ...
    <div class="cast-box">
      <img src="play-page/zendaya.jpg" alt="" class="cast-img">
      <span class="cast-title">zendaya</span>
    </div>
    <div class="cast-box">
      <img src="play-page/tobey maguire.jpg" alt="" class="cast-img">
      <span class="cast-title">Tobey Maguire</span>
    </div>
    <div class="cast-box">
      <img src="play-page/andrew garfield.jpg" alt="" class="cast-img">
...
<div class="download">
  ...
  <div class="download-links">
    <a href="play-page/spider man.mp4" download>480p</a>
    <a href="play-page/spider man.mp4" download>720p</a>
    <a href="play-page/spider man.mp4" download>1080p</a>
  </div>
</div>
