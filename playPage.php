...
<div class="play-container container">
  <!--Play image-->
  <img src="images/black widow2.jpg" alt="" class="play-img">
  <!-- Play text-->
  <div class="play-text">
    <h2>Black widow</h2>
    <!--ratings-->
...
<!--Video box-->
<div class="video-box">
  <video id="myvideo" src="play-page/black widow.mp4" controls=""></video>
  <!--close video-->
...
<div class="about-movie container">
  <h2>Black Widow</h2>
  <p>In Marvel Studios’ action-packed spy thriller “Black Widow,” Natasha Romanoff aka Black Widow confronts the darker parts of her ledger when a dangerous conspiracy with ties to her past arises. Pursued by a force that will stop at nothing to bring her down, Natasha must deal with her history as a spy and the broken relationships left in her wake long before she became an Avenger.</p>
  <!--Movie Cast-->
  <h2 class="cast-heading">Move Cast</h2>
  <div class="cast">
    <div class="cast-box">
      <img src="play-page/scarlatt johansson.jpg" alt="" class="cast-img">
      <span class="cast-title">Scarlett Johansson</span>
    </div>
    <div class="cast-box">
      <img src="play-page/david harbour.jpg" alt="" class="cast-img">
      <span class="cast-title">David Harbour</span>
    </div>
    <div class="cast-box">
      <img src="play-page/florence pugh.jpg" alt="" class="cast-img">
      <span class="cast-title">Florence Pugh</span>
    </div>
    <div class="cast-box">
      <img src="play-page/rachel weisz.jpg" alt="" class="cast-img">
      <span class="cast-title">Rachel Weisz</span>
    </div>
  </div>
</div>
<!--Download-->
<div class="download">
  ...
  <div class="download-links">
    <a href="play-page/black widow.mp4" download>480p</a>
    <a href="play-page/black widow.mp4" download>720p</a>
    <a href="play-page/black widow.mp4" download>1080p</a>
  </div>
</div>
